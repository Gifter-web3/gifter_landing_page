...
const Navbar = () => {
  ...
  return (
    <>
      <div className="hidden sm:flex w-full justify-center top-[50px] absolute z-50">
      ...
      <nav className="block sm:hidden">
        <div className="flex justify-between items-center bg-black p-5 w-full h-[81px] gap-[290px] z-30">
        ...
        {isActive && (
          <div className="flex flex-col items-center justify-start pt-[200px] px-[50px] z-50 gap-1 absolute top-[81px] right-0 w-full h-[90%] bg-slate-900 text-white font-medium text-[20px] font-Inter leading-[25px]">
