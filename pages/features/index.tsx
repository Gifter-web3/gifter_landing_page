  ...
  return (
    <div className="relative">
      <div className="flex w-full flex-col h-auto overflow-hidden relative">
        <div className="w-full bg-features h-[952px]">
          <Image
            src={StarEffectImg}
        ...
        <div className="flex justify-center">
          <div className="absolute top-[273px] left-[230px]">
            <p className="font-Orbitron font-bold text-[80px] w-[865px] leading-[80px] tracking-[-1px] text-white">
              Buy, trade, and hold 350+ Giftcards
            </p>
            <p className="font-medium text-[18px] pt-[3rem] leading-6 text-[#6F698E] w-[865px]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut laboret dolore magna aliqua. Ut enim
              ad minim veniam, quis nostrud exercitation
            </p>
            <div className="mt-[53px] flex flex-col gap-2">
      ...
      <div className="flex flex-col items-center bg-black">
        <div className="flex flex-col gap-[30px]">
          <p className="font-bold text-[55px] leading-[55px] font-Orbitron text-white">
            Build your Gifter Portfolio
          </p>
          <p className="font-Inter text-[18px] leading-[28px] font-normal text-[#FFFFFF99] w-[635px] text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat
            nulla suspendisse tortor aene.
          </p>
        </div>

        <div className="bg-black text-white flex items-center justify-center py-[100px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-start w-[477px] !bg-[#6538AD] rounded-3xl py-[48px] px-[23px] border-[2px] border-gradient gap-[30px] relative">
              <div className="flex justify-center w-full absolute bottom-0 right-0">
                <Image
                  src={IPhone}
                  alt="Send and Receive"
                  className="w-[355px] h-[442px]"
                />
              </div>
      ...
      <div className="bg-features-reward">
        <div className="flex justify-center py-[100px] gap-[118px]">
          ...
          <div className="flex flex-col items-start w-[529px] gap-[45px]">
            <div className="flex flex-col items-start gap-6">
              <p className="font-bold font-Orbitron text-[42px] leading-[51px] text-white">
                Earn daily rewards on your idle tokens
              </p>
              <p className="font-Inter font-normal text-lg gap-[28px] w-[529px] text-[#FFFFFF99]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat
                nulla suspendisse tortor aene.
              </p>
            </div>
            <div className="flex flex-col items-start gap-[17px] text-white">
              <div className="flex justify-between gap-[17px]">
                <Image src={Lowest} alt="Lowest fees" width={46} height={46} />
        ...
        <div className="flex justify-center py-[100px] gap-[118px]">
          <div className="flex justify-end w-full mt-[90px]">
            <div className="flex flex-col items-start w-[529px] gap-[45px]">
              <div className="flex flex-col items-start gap-6">
                <p className="font-bold font-Orbitron text-[42px] leading-[51px] text-white">
                  Earn daily rewards on your idle tokens
          ...
          <div className="flex justify-end w-full">
            <Image src={AppleComputerL} alt="Apple Computer" className="z-30" />
          </div>
        </div>
      </div>

      <div className="flex justify-center py-[150px] gap-[118px] bg-black">
        <div className="flex justify-end w-full mt-[90px]">
          <div className="flex flex-col items-start w-[529px] gap-[45px]">
            <div className="flex flex-col items-start gap-6">
              <p className="font-bold font-Orbitron text-[42px] leading-[51px] text-white">
        ...
        <div className="flex justify-start items-end w-full pb-[25px]">
          <Image
            src={Video}
            alt="Apple Computer"
            className="z-30 w-[662px] h-[400px]"
          />
        </div>
      </div>
