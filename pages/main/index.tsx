...
const Main = () => {
  return (
    <div className="flex flex-col w-full relative">
      <div className="flex justify-center w-full relative banner-gradient pb-[390px]">
        <div className="flex flex-col items-center w-[1112px] pt-[218px]">
          ...
          <p className="text-lg leading-[25px] font-medium text-[#6F698E] text-center w-[755px] py-7">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut laboret dolore magna aliqua. Ut enim ad
        ...
        <Image
          src={CursorL}
          alt="Cursor"
          className="w-[18%] h-auto absolute top-[45%] left-[50px] xl:left-[190px]"
        />
        <Image
          src={MessgeR}
          alt="Cursor"
          className="w-[18%] h-auto absolute bottom-[255px] right-[60px] xl:right-[127px]"
        />
      </div>
      ...
      <div className="flex flex-col justify-center items-center py-[100px] bg-black relative">
        <div className="text-center w-[828px] ">
          <p className="text-[54px] leading-[60px] font-bold font-Orbitron text-white">
            Everything you need
          </p>
          <p className="text-[22px] leading-[31px] font-normal font-Inter text-white pt-5">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore
          </p>
        </div>
        <div className="flex justify-center gap-[58px] pt-[60px]">
          {LoremData.map((data) => {
            return (
              <div
                className="flex flex-col justify-center items-center w-[376px] h-[260px] rounded-3xl py-[27px] px-[42px] border-[2px] border-gradient gap-[30px]"
                key={data.title}
              >
      ...
      <div className=" bg-gradient3 w-full h-[98rem] relative">
        <div className="flex justify-center py-[100px]">
          <div className="flex flex-col w-[1244px] h-[368px] rounded-[27px] border-[2px] gap-[30px] px-[45px] py-[46px] bg-gradient2">
            <div className="flex justify-center gap-[30px]">
              <div className="flex justify-start items-center">
                <Image src={Rectangle} alt="Rectangle" width={66} height={66} />
              </div>
              <div className="flex flex-col w-[87%] gap-[18px]">
                <p className="font-Orbitron font-bold text-[40px] leading-[48px] text-white">
                  {" "}
                  Unlock unlimited possibilities
                </p>
                <p className="font-Inter font-semibold text-xl leading-[22px] text-white">
            ...
            <div className="flex justify-between px-[32px] items-center">
              <div className="flex flex-col justify-start gap-[30px]">
                <Image src={Encrypted} alt="Encrypted" width={50} height={50} />
                <p className="font-Monrope font-semibold text-[23px] text-white leading-[24px]">
                  Protect Your Fiats
                </p>
              </div>
              <div className="w-[7px] h-[50px] bg-[#D25804]"></div>
              <div className="flex flex-col justify-start gap-[30px]">
                <Image
                  src={Cryptocurrency}
                  alt="Encrypted"
        ...
        <div className="flex justify-center py-[100px] w-full">
          <div className="flex flex-col gap-[60px] text-center">
            <p className="font-Orbitron font-bold text-[54px] leading-[60px] text-white">
            ...
            <div className="flex justify-center gap-[30px]">
              {GeneratorData.map((item) => {
                return (
                  <div
                    className="flex justify-center items-center w-[369px] h-[440px] border-[2px] py-[27px] px-[42px] rounded-[24px] border-gradient"
                    key={item.name}
                  >
                    <Image
                      src={item.img}
            ...
            <p className="font-semibold font-Inter text-lg leading-[24px] text-white text-center w-[1005px]">
              At Gifter, we believe “The Perfect Gift Starts with Us. Together,
              We Create Unforgettable Moments.” Join our community of innovative
              thinkers and experience the future of gifting.
            ...
            <div className="flex justify-center w-full">
              <button className="bg-white text-black rounded-[10px] px-[15px] py-[10px] w-[162px] font-medium text-base leading-[19p] font-Inter">
                Become a Gifter
              </button>
            </div>
            <Image
      ...
      <div className="bg-black h-auto relative">
        <div className="flex justify-between py-[100px]">
          <div className="relative w-1/2">
            <Image
              ...
              width={275}
              height={326}
              className="absolute z-50 left-[416px] top-0"
            />
            <Image
              src={Sphere}
              alt="Sphere"
              width={172}
              height={172}
              className="absolute z-30 top-[133px] left-[322px]"
            />
            <Image
              src={StarImg}
              alt="Star"
          ...
          <div className="flex flex-col items-start gap-8 pr-[130px]">
            <p className="font-Orbitron font-black leading-[52px] text-[40px] text-white w-[620px]">
              24/7 access to full service customer support
            </p>
            <p className="font-Inter text-base leading-[24px] font-normal w-[580px] text-white">
            ...
            <button className="w-[190px] h-[56px] rounded-[10px] border-[1px] text-white border-white text-base font-semibold font-Inter">
              Get Started
            </button>
          </div>
        </div>
        <Image
          ...
          className="w-[670px] h-[1143px] absolute top-[-100px] left-"
        />
        <BuyAndSellGiftcard />
        <TakeCareGiftcard />
      </div>
